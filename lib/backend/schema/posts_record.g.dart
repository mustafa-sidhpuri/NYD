...
class _$PostsRecordSerializer implements StructuredSerializer<PostsRecord> {
  ...
  Iterable<Object?> serialize(Serializers serializers, PostsRecord object,
    ...
    value = object.conversationUsersId;
    if (value != null) {
      result
        ..add('conversationUsersId')
        ..add(serializers.serialize(value,
            specifiedType:
                const FullType(BuiltList, const [const FullType(String)])));
    }
      ...
      switch (key) {
        ...
        case 'conversations':
          result.conversations.replace(serializers.deserialize(value,
              ...
              as BuiltList<Object?>);
          break;
        case 'conversationUsersId':
          result.conversationUsersId.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(String)]))!
              as BuiltList<Object?>);
          break;
...
class _$PostsRecord extends PostsRecord {
  ...
  @override
  final BuiltList<String>? conversationUsersId;
  @override
...
class PostsRecordBuilder implements Builder<PostsRecord, PostsRecordBuilder> {
  ...
  ListBuilder<String>? _conversationUsersId;
  ListBuilder<String> get conversationUsersId =>
      _$this._conversationUsersId ??= new ListBuilder<String>();
  set conversationUsersId(ListBuilder<String>? conversationUsersId) =>
      _$this._conversationUsersId = conversationUsersId;
  ...
  _$PostsRecord _build() {
    ...
    try {
      ...
      try {
        ...
        _$failedField = 'conversationUsersId';
        _conversationUsersId?.build();
